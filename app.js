import {
  ...
  STATUS_TIMEOUT_MS,
} from "./js/core/config.js?v=20260912-task24-4-r2";
import {
  capabilityProblems,
  detectCapabilities,
  randomId,
} from "./js/core/capabilities.js?v=20260912-task24-4-r2";
import {
  createApiClient,
  fetchWithTimeout,
  ...
  waitForDelay,
} from "./js/core/api.js?v=20260912-task24-4-r2";
import {
  loadCloudChangelog,
  mergeChangelogEntries,
  staticChangelogEntries,
} from "./js/core/changelog.js?v=20260912-task24-4-r2";
import { APP_ROUTE_MANIFEST, createRouter, createNativeNavigation } from "./js/core/router.js?v=20260912-task24-4-r2";
import {
  ACCOUNT_CACHE_KEY,
  isThewyjAndroidApp,
...
} from "./js/core/session.js?v=20260912-task24-4-r2";
import { getSafeStorage, hasStorageWriteFailure, loadJson, safeStorageSet } from "./js/core/storage.js?v=20260912-task24-4-r2";
import { $, escapeHtml, formatLocalDateTime, writeClipboardText } from "./js/core/ui.js?v=20260912-task24-4-r2";
import { initDesignSystem, setExperienceMode } from "./js/core/design-system.js?v=20260912-task24-4-r2";
import { createAndroidDownloadController } from "./js/core/download.js?v=20260912-task24-4-r2";
import { speakText, stopSpeech } from "./js/language/speech.js?v=20260912-task24-4-r2";
import {
  loadSpeechRate,
  saveSpeechRate,
} from "./js/language/speech-rate.js?v=20260912-task24-4-r2";
...
import {
  ...
  studyDaySeries,
} from "./js/language/history.js?v=20260912-task24-4-r2";
import {
  DEFAULT_PROFILE,
  LANGUAGE_LABELS,
  analyzeWordList,
  ...
  wordIdentity,
  wordMatchesLanguage,
} from "./js/language/quiz.js?v=20260912-task24-4-r2";
import { createLearningSyncAdapter } from "./js/language/sync-adapter.js?v=20260912-task24-4-r2";
import { createWrongBookPdf } from "./js/language/pdf.js?v=20260912-task24-4-r2";
import {
...
} from "./js/language/wrong-book.js?v=20260912-task24-4-r2";
import {
  ...
  membershipLabel,
} from "./js/membership/account.js?v=20260912-task24-4-r2";
import {
  MEMBERSHIP_GOALS,
...
} from "./js/membership/plans.js?v=20260912-task24-4-r2";
import {
  ...
  paymentStatusLabel,
  rechargeStatusLabel,
} from "./js/membership/recharge.js?v=20260912-task24-4-r2";
import {
  loginLocationLabel,
  loginReasonLabel,
  membershipDateValue as membershipDateValueModel,
} from "./js/admin/formatters.js?v=20260912-task24-4-r2";
