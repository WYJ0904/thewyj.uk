...
class StaticSiteTests(unittest.TestCase):
    ...
    def test_manifest_and_service_worker_shell_are_deployable(self):
        ...
        release_token = "20260824-task15-cloud-only"
        ...
        self.assertIn('export const APP_VERSION = "2026-08-24-task15-cloud-only"', self.core)
        for module in ("api", "config", "router", "session", "storage", "ui"):
            self.assertIn(f'/js/core/{module}.js?v={release_token}', self.worker)
        self.assertIn('type="module" src="/app.js?v=20260824-task15-cloud-only"', self.html)
