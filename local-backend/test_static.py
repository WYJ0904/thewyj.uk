...
class StaticSiteTests(unittest.TestCase):
    ...
    def test_manifest_and_service_worker_shell_are_deployable(self):
        ...
        release_token = "20260914-task24-device-r4"
        ...
        self.assertIn('export const APP_VERSION = "2026-09-14-task24-notification-finance-r4"', self.core)
        ...
        self.assertIn('type="module" src="/app.js?v=20260914-task24-device-r4"', self.html)
    ...
    def test_task19_design_system_two_contract(self):
        self.assertIn('href="/design-system.css?v=20260914-task24-device-r4"', self.html)
        self.assertIn('href="/public-experience.css?v=20260914-task24-device-r4"', self.html)
        self.assertIn('href="/workspace-experience.css?v=20260914-task24-device-r4"', self.html)
