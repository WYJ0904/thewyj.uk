  ...
  try {
    await check("brief branded startup and unauthenticated navigation", async () => {
      ...
      const pwa = await evaluate(`(async () => {
        ...
        const cachedProductStyles = await caches.match('/product-ui.css?v=20260824-task14-production-r2');
        const cachedChangelog = await caches.match('/changelog.js?v=20260824-task14-production-r2');
        const cachedLearningSync = await caches.match('/learning-sync.js?v=20260824-task14-production-r2');
        const cachedWorkflows = await caches.match('/workflows.js?v=20260824-task14-production-r2');
      ...
      assert.equal(await evaluate("localStorage.getItem('wyjChangelogSeenVersion:v1')"), "2026-08-24-task14-production-r2");
