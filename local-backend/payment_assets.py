...
_PLAN_FILENAMES = {
    ...
    # The finance order keeps its own plan-bound resource ID while reusing the
    # existing private receiver QR for the same payment method.
    "finance_monthly": "all_access_monthly.png",
