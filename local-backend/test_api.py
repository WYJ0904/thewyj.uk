...
class AccountApiTests(unittest.TestCase):
    ...
    def test_membership_catalog_prices_and_order_confirmation(self):
        ...
        self.assertEqual(by_code["notification_archive_access"]["price_cents"], 800)
        self.assertEqual(by_code["notification_archive_access"]["name"], "通知保存")
        ...
        self.assertEqual(by_code["notification_archive_access"]["entitlements"], ["notification_archive_access"])
        self.assertIn("notification_archive_access", by_code["all_access_monthly"]["entitlements"])
        self.assertIn("notification_archive_access", by_code["all_access_lifetime"]["entitlements"])
