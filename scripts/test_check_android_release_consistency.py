...
class AndroidReleaseConsistencyTest(unittest.TestCase):
    ...
    def test_superseded_apk_digest_is_rejected(self) -> None:
        self.patch_metadata(apkSha256="1faf2dc27076efbcc2c94adb803a692f0deb7a32c8679bf020858b74d15fd198")
        result = run_gate(self.root)
        self.assertNotEqual(result.returncode, 0)
        self.assertIn("superseded 1.3.4 digest", result.stdout)
    ...
    def test_apk_file_name_and_key_convention_is_rejected(self) -> None:
        self.patch_metadata(apkFileName="thewyj-android-1.3.4.apk", apkKey="app/android/thewyj-android-1.3.4.apk")
        result = run_gate(self.root)
        self.assertNotEqual(result.returncode, 0)
