import { ACCOUNT_SESSION_KEY, accountSessionHeaders } from "../core/session.js?v=20260911-permissions-nav-dictation-r1";
import { getSafeStorage } from "../core/storage.js?v=20260911-permissions-nav-dictation-r1";
